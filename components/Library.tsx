...
export function Library({ dict }: { dict: any }) {
    return (
        <section className="py-24 bg-black/20">
            <div className="container mx-auto px-6">
                <div className="grid grid-cols-1 lg:grid-cols-2 gap-12 lg:gap-16 items-center">
                    ...
                    >
                        <h2 className="text-4xl font-bold text-white mb-8 font-display">{dict.vision}</h2>
                        <div className="aspect-video glass rounded-[32px] overflow-hidden relative group">
                            ...
                            <div className="absolute bottom-6 left-6 text-white text-xs font-semibold tracking-widest opacity-60">
                    ...
                    >
                        ...
                        <span className="text-polis-accent font-bold tracking-[0.3em] text-xs uppercase mb-6 block font-display">{dict.resources}</span>
                        <h3 className="text-3xl font-black text-white mb-6 leading-tight font-display">{dict.protocol_foundations}</h3>
                        ...
                        <button className="bg-white text-polis-primary px-8 py-4 rounded-xl font-bold flex items-center justify-center gap-4 hover:bg-polis-accent transition-colors w-full sm:w-auto">
                            <span className="whitespace-nowrap">{dict.download_button}</span>
                            <svg
                                width="24"
                                height="24"
                                viewBox="0 0 24 24"
