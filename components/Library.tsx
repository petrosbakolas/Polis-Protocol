        ...
        <section className="py-24 bg-black/20">
            <div className="container mx-auto px-6">
                <div className="grid grid-cols-1 lg:grid-cols-2 gap-16 items-center">
                    ...
                    >
                        <h2 className="text-4xl font-bold text-white mb-8">{dict.vision}</h2>
                    ...
                    >
                        ...
                        <span className="text-polis-accent font-bold tracking-[0.3em] text-xs uppercase mb-6 block">{dict.resources}</span>
                        <h3 className="text-3xl font-black text-white mb-6 uppercase leading-tight">{dict.protocol_foundations}</h3>
                        ...
                        <button className="bg-white text-polis-primary px-8 py-4 rounded-xl font-black flex items-center gap-4 hover:bg-polis-accent transition-colors">
                            <span>{dict.download_button}</span>
