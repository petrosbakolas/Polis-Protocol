        ...
        <section className="py-24 bg-polis-primary/50 relative">
            <div className="container mx-auto px-6">
                <div className="text-center mb-20">
                    <h2 className="text-4xl md:text-5xl font-bold text-white mb-4 uppercase">{dict.title}</h2>
                ...
                <div className="grid grid-cols-1 md:grid-cols-3 gap-12">
                    {cards.map((card, index) => (
                        ...
                        >
                            ...
                            <h3 className="text-2xl font-bold text-white mb-6 tracking-wide uppercase">{card.title}</h3>
