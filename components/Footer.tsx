            ...
            <div className="container mx-auto px-6">
                <div className="flex flex-col md:flex-row justify-between items-center gap-12">
                    <div className="max-w-md text-center md:text-left">
                        <h4 className="text-3xl font-black text-white mb-4">JOIN THE FEDERATION</h4>
                        <p className="text-white/40 mb-8">
                            Be the first to receive updates on architectural milestones and the protocol launch.
                        </p>
                        <div className="flex gap-4">
                            <input
                                type="email"
                                placeholder="architect@polisprotocol.org"
                            ...
                            />
                            <button className="bg-polis-accent text-polis-primary px-8 py-4 rounded-xl font-bold hover:scale-105 transition-transform">
                                JOIN
                            </button>
                        </div>
                    </div>
                ...
                <div className="mt-24 pt-8 border-t border-white/5 flex flex-col md:flex-row justify-between items-center gap-6 text-white/20 text-xs tracking-widest">
                    <p>© 2026 POLIS PROTOCOL FOUNDATION. ALL RIGHTS RESERVED.</p>
                    <p>BUILT ON THE EDGE. ANCIENT WISDOM, DIGITAL FUTURE.</p>
                </div>
            </div>
        </footer>
    );
